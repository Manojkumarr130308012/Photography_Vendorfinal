...
import com.astr.hc.celebrations.Api.ApiService;

import com.astr.hc.celebrations.Config.DBHelper;
import com.astr.hc.celebrations.Util.FileUtils;
import com.astr.hc.celebrations.Util.InternetConnection;
import com.astr.hc.celebrations.Util.PhtotAdapter;
        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (totalselect <= videostotal){
                    ...
                    Snackbar.make(view, "Allowed Only  "+-(imagegetcount-videostotal)+"  Images...Please Upgrade Your Plan!!!", Snackbar.LENGTH_LONG)
