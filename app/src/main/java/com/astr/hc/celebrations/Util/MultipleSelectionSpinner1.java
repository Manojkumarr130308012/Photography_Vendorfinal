...
public class MultipleSelectionSpinner1 extends AppCompatSpinner implements
    ...
    public void setItems(List<String> items,List<String> itemsid) {
        _items = items.toArray(new String[items.size()]);
        _itemsid=itemsid.toArray(new String[items.size()]);
        mSelection = new boolean[_items.length];
        simple_adapter.clear();
        simple_adapter.add("category");
        ///simple_adapter.add(_items[0]);
        Arrays.fill(mSelection, false);
    }
